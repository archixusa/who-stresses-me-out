...
def main():
    ...
    _cmd(app, "shortcuts", shortcuts_cmd)
    _cmd(app, "add", add_shortcut_cmd)
    _cmd(app, "remove", remove_shortcut_cmd)
    _cmd(app, "delete", delete_cmd)
    _cmd(app, "mydata", mydata)
    _cmd(app, "export", export_cmd)
    _cmd(app, "deletemydata", deletemydata)
